...
export class Backend implements backendInterface {
    ...
    async getDefaultPreferences(): Promise<Preference> {
        if (this.processError) {
            try {
                const result = await this.actor.getDefaultPreferences();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserPreference(): Promise<Preference> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserPreference();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setUserPreference(arg0: Preference): Promise<void> {
        if (this.processError) {
            try {
